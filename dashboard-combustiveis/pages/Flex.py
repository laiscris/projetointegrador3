...
st.markdown('''
    * **:arrow_down_small: ABAIXO DE 70%**, o preço do Etanol representa menos de 70% do preço da Gasolina. Portanto, o **ETANOL É MAIS VANTAJOSO**.
            
    * **:arrow_up_small: ACIMA DE 70%**, o preço do Etanol representa mais de 70% do preço da Gasolina. Portanto, a **GASOLINA COMPENSA MAIS**
...
df_comparacao_mostrar = df_comparacao_final.loc[:, ['DATA', 'ETANOL HIDRATADO', 'GASOLINA COMUM', '% RAZAO ETANOL_GASOLINA']]
